...
module.exports = (lublu) => {
	...
	require('./psql.dao.rights')(lublu);
	require('./sql')(lublu);

	const SQL = lublu.SQL;
	
	lublu.PsqlPostDAO = lublu.PsqlPostDAO || class PsqlPostDAO {
		constructor(db, blog) {
			this.db = db;
			this.blog = blog;
			...
			this.tagDAO = new lublu.PsqlTagDAO(db);
			this.rightsDAO = new lublu.PsqlRightsDAO(db);
		}
